...
- Tax evasion is a **widespread** phenomenon: 
  - Long-standing concern for developing countries
  - In developed countries: policy attention ramped up significantly after the 2008 crisis .small[(Slemrod, 2019) [&#9654; Stats](#tax-stats)]
- Tax evasion has not been **satisfactorily** addressed in the estimation of production functions and productivity
  - Treated as classical measurement error .small[(e.g., Blalock et al., 2004, p.204)]
  - Tax-evasion misreporting: likely to be correlated with the firm's characteristics and not mean zero (unidirectional b/c IC)
...
Relevant for:
- Practitioners
  - Production functions and Productivity are **fundamental** questions in **IO**
  - Productivity and production function parameters are **inputs** for numerous fields (e.g., trade, growth and development, etc.)
  - Corporate tax evasion is an open question in **public economics**
- Policy-makers
  1. Related to tax compliance and enforcement: Firm-level estimates of tax evasion will help an **efficient targeting** to improve government tax revenue
  2. Related to growth: Estimates of productivity bias by firms due to tax evasion will help policies aiming for an **efficient reallocation** of resources from low- to high-productivity firms .small[(Eslava et al., 2004; Levy, 2018)].
...
- How can we recover unbiased **production function parameters** and **productivity** in the presence of **tax evasion** using commonly available data?
- What is the **magnitude** of the bias of the production function parameters and productivity?
- How does the true **productivity distribution** compare to the mismeasured one?
- How can we estimate firm-level **tax evasion** considering their productivity?
- What are the **policy implications** 
  - of using a mismeasured firm-level productivity due tax evasion (mistargeted firms)
  - of having an accurate firm-level estimate of tax evasion (efficiency gains in compliance)
...
- Tax evasion: Illegal actions to reduce tax liabilities .small[(Slemrod, 2019)[&#9654; Lit conventions](#tax-conv) [&#9654; Lit Overview](#tax-stats)]
  - Traces of income: Researchers recover the true income of evaders by comparing an observable measure of true income between evaders and non-evaders.  .small[(Artavanis, 2016; Paulus, 201); Dunbar and Fu, 2015) [&#9654; Seminal paper: Pissarides and Weber (1989)](#traces)]
  - Corporate tax evasion by cost overreporting: Widespread and quantitatively important but largely understudied, mainly due to lack of data; until recently .small[ (Zumaya et al., 2021; [&#9654; Carrillo et al., 2022](#cost-over)); [&#9654; Other taxes firms evade](#firms-evasion)]
- Production function .small[(GNR,2020; ACF, 2015)]
  - Measurement error in capital .small[(Collard et al., 2020; Ursenbach's JMP)]. 
  - This paper: Systematic overreporting of intermediate inputs
...
- Why hasn't this been done before?
  - Recent empirical evidence shows tax evasion through cost overreporting is widespread and quantitatively large
  - Recent developments in the econometrics of unobservables
- Why am I the one who can do this?
  -  I'm the one linking these two areas
  - Western's formation in structural estimation and production functions (IO)


---
layout: true
### A simple model of tax evasion by cost overreporting
---
...
.small[[&#9654; Potential sources of identification](#id-sources)]
