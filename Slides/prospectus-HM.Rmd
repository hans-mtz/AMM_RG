...
- Assumptions: .small[[&#9654; Empirical evidence](#evidence)]
  ...
  - (A-2) Firms choose overreporting $\varepsilon^X_{it}$ after productivity shock $\omega_{it}$ is realized and true inputs $x^*_{it}$ are chosen but before the current-period exogenous shock $\varepsilon^Y_{it}$
...
.small[Note: Likewise for productivity and true inputs. (A-2) not needed]

---
### Using deconvolution

- I can learn how the distribution and any moment of tax evasion has changed over time

- Furthermore, I can get any mixed moment $\mathbb{E}[(\mathcal{Z}^c, \mathcal{Z}^d)^n]$
  - I can learn how tax evasion changes with productivity over time, for example
...
- Firms optimize true inputs maximizing before-tax profits
  ...
  - In the tax-compliance literature, individual income is usually treated as given. However, we could think there is self-selection of individuals into jobs where evading taxes can be more or less difficult
