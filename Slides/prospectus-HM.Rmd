...
- More **relevant** than we thought .small[Ecuador: [&#9654; (Carrillo et al. 2022)](#carrillo)]
  ...
  - Quantitatively large .small[up to 14% of total annual purchases]
  - Not unique to small firms .small[vs. previous consensus]
  - Very large firms do not overreport inputs .small[More sophisticated (Profit shifting: Bustos et al., 2022); Higher risk of getting caught: third-party reporting (ISO), government attention]
...
- What are the effects of ignoring this type of evasion on production function and productivity estimation?

- How can we recover productivity in the presence of tax evasion?

- How can we learn about tax evasion with commonly available data like manufacturing surveys?

- What are the policy implications of using the wrong measures of productivity due to tax evasion?

- What could be the policy recommendations, if we're successful?
...
The first-order conditions of the cost-minimization problem of the firms are informative about optimal input utilization

Since I have a subset of non-evading firms, I can back up input overreporting of tax-evading firms, up to a white noise

I can then recover productivity using this tax-evasion analog

Moreover, I can use deconvolution methods to recover the tax evasion distribution
...
- We want to estimate the production function $G$ and </br> productivity $\omega_{it}$, allowing for classical measurement error $\varepsilon^Y_{it}$
