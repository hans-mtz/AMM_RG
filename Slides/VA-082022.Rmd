...
output:
  xaringan::moon_reader:
    ...
    nature:
      slideNumberFormat: "%current%/10" #"%current%/%total%"
...
Cost overreporting of firms to evade taxes .small[(Carrillo et al., 2022)] is 
- globally prevalent, 
- widespread, 
- quantitatively large, and 
- understudied

Unsatisfactorily addressed in the production function estimation: Treated as measurement error

Tax evasion will downward bias the productivity measurements and reshuffle firms in the recovered productivity distribution
...
Challenge: Disentangle unobserved productivity and unobserved systematic misreporting
...
- Identification strategy
  - Econometrics of unobservables/ Traces: Hu and Yao (2022); Hu (2021); Hu and Shennach (2018)
  - Structural: Leverage optimization problem of tax evasion
- Data
  - Mexico
  - Ecuador
  - Colombia
...
# Stochastic Revealed Preferences/Profit-Maximization

---
### Current status

Cournot competition
- Fail to reject null with measurement error
- Does it have any bite? MC simulations to identify conditions
  - Demand: Improve demand moment conditions (Roy)
  - Marginal costs: Redefine in terms of concavity of profit function (IO guys didn't blink)
  - Productivity: Redefine in terms of concavity of production function
- Find industry of interest
  - Meat bagging (Daniel's suggestion)
  - Cement
  - Gasoline
...
- SRP Market Power test
- Markup robust bounds

---
class: inverse center middle
count: false

# Entry: complementarity and switching costs

---
### Entry: complementarity and switching costs

- Complementarities and switching costs in the demand of the home appliances market might:
  - incentivize established firms to forgo today's profits to avoid recovering market shares tomorrow in the presence of entry
  - impede the entry of small firms, thus, slowing innovation and development of new products
...
# Immigrant labor market and productivity in Canada

---
### Immigrant labor market and productivity in Canada

- Although immigrants are critical for the economic development of Canada, the unemployment and underemployment rates among immigrants are higher than for natives .small[(Adamuti-Trache, 2016)]. 
- On the other hand, firms face higher costs and declare themselves incapable of assessing foreign credentials .small[(Chhinzer and Oh, 2021)]. 
- These frictions for immigrants on both sides of the market might negatively affect firm productivity. 
- The objective is to study to what extent these frictions jointly reduce productivity at the firm level in Canada. Break *Hicks-neutrality* assumption.
...
```{r, out.width="90%"}
library(qrcode)
qr <- qrcode::qr_code('https://raw.githack.com/hans-mtz/Slides/main/Slides/VA-082022.html')
plot(qr)
...
Principal chooses $t(\cdot)$, $f(\cdot,I)$, and a report $x\in \phi(I)$ to maximize $\mathbb E [R(x,I)]$ (expectation taken wrt $G(I)$ ).
...
- MC Simulations: 
  - Define simplest functional model
  - Identification and estimation with the simulated data
- Get data: Ecuador, Colombia, Mexico
